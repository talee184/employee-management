...
import com.talee.employee.management.filter.JwtFilter;
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
    return httpSecurity
        ...
        .authorizeHttpRequests(auth -> auth
            .requestMatchers("/auth/add-user", "/auth/login")
        ...
        .addFilterBefore(jwtFilter,
            UsernamePasswordAuthenticationFilter.class) // Add the JWT filter before processing the request
        .build();
  }
